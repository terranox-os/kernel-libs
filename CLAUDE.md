...
> **Migration note (2026-05-11)**: Two TerranoxOS-specific runtime projects formerly hosted here have been extracted:
>
> - `trx-ui/` → [`terranox-os/trx-ui`](https://github.com/terranox-os/trx-ui) (Zig UI toolkit, own repo)
> - `trx-compositor/` → [`terranox-os/terranox-desktop`](https://github.com/terranox-os/terranox-desktop) as `crates/trx-compositor/`
>
...
```
Layer 0:  genesis-abi (C headers = source of truth, Rust mirror, external consumers pin via tag/submodule)
...
External consumers of `genesis-abi`: [`trx-libc`](https://github.com/terranox-os/trx-libc), [`trx-ui`](https://github.com/terranox-os/trx-ui), and [`terranox-desktop`](https://github.com/terranox-os/terranox-desktop)'s `crates/trx-compositor` all pin to a tag — currently [`genesis-abi-v0.1.0`](https://github.com/terranox-os/kernel-libs/releases/tag/genesis-abi-v0.1.0). Bump deliberately when the syscall ABI or capability model changes.
...
- **181 Rust tests + 144 C tests = 325 total**, all passing
  - genesis-abi 50, alloc 7, bitops 25, collections 35, crypto 11, devicetree 11, elf 15, kfmt 15, sync 12 (arch-intrinsics has none — pure intrinsics)
